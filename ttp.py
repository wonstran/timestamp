#----------------------------------------------------------------------------------------
#-------Updated in 05-08-2019 by wonstran
#-------1 - updated output
#-------2 - added running time
#----------------------------------------------------------------------------------------
...
def creation_time(filename):
    ...
    #print ("==========output==========") #disable by wonstran
    #print (out)							#disable by wonstran
    if err:
        print ("========= error ========")
        print (err)
    t = out.splitlines()
...
#-------update----------------------------------------------------------------------------
indir = "/media/usb/inc_rrx_afte_ videos/pembrooke_rd/"  #"/media/usb/NDS/AFTER/Miami/Angle2/"
...
for root, dirs, filenames in os.walk(indir):
    ...
    for f in filenames:
        if f[-4:] == '.MP4' or f[-4:] == '.mp4':
            ...
            count = count + 1
            print('Start to timestamp ' + str(count) + ' videos: ' + str(f))
            ...
            if status == True: 
                ...
                ff = dt.datetime.strptime(t.split("'")[1], "%Y-%m-%d %H:%M:%S")
                ...
                #-------update----------------------------------------------------------
                ff2 = "inc_rrx_afte_D4_pembrooke_rd_" + ff + ".MP4"
                ...
                initial = dt.datetime.strptime(t.split("'")[1], "%Y-%m-%d %H:%M:%S")
                timestamp = initial
                ...
                while current_frame < total_frames:
                    ...
                    print("Processing {}/{} frames".format(int(current_frame), int(total_frames)), end="\r")
                ...
                print("Video has been timestamped using " + str(duration) + ' minutes')
